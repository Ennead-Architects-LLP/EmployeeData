...
def main():
    ...
    if not args.send_to_github and not args.send_as_issue:
        print("\n💡 Tip: Use --send-to-github to send data to the website")
        print("   Example: python about_me.py --send-to-github --github-token YOUR_TOKEN")
        print("   The data will be processed by GitHub Actions and appear on the website.")
    
    if success:
        print("\n✅ Collection and transmission complete!")
    else:
        print("\n⚠️  Collection complete, but some transmissions failed!")
